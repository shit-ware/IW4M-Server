...
#include "StdInc.h"
float cgFov120 = 120.0f; //Shouldn't be here :P
...
void PatchMW2_Dvars()
{
	...
	*(BYTE*)0x404CD5 = 0xFF;
	...
	// un-protect sv_cheats
	//*(BYTE*)0x647E0F = DVAR_FLAG_CHEAT;//sv_cheats write protected
	//*(BYTE*)0x647F41 = DVAR_FLAG_CHEAT;//sv_cheats cannot be changed
