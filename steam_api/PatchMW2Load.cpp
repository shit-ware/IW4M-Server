...
void __cdecl FFLoadHook1(XZoneInfo* data, int count, int unknown) {
	...
	newData[count + 2].name = "weap_oilrig";
	newData[count + 2].type1 = newData[2].type1;
	newData[count + 2].type2 = newData[2].type2;
	newData[count + 3].name = "repz_roadkill";
	newData[count + 3].type1 = newData[3].type1;
	newData[count + 3].type2 = newData[3].type2;
	newData[count + 4].name = "repz_bridge";
	newData[count + 4].type1 = newData[3].type1;
	newData[count + 4].type2 = newData[3].type2;
	newData[count + 5].name = "repz_iw4m";
	newData[count + 5].type1 = newData[3].type1;
	newData[count + 5].type2 = newData[3].type2;
	/*newData[2].name = "iw4_wc_shaders_min";
	newData[2].type1 = newData[2].type1;
	newData[2].type2 = 0;
	newData[3].name = "weap_oilrig";
	newData[3].type1 = 4;
	newData[3].type2 = 0;*/
