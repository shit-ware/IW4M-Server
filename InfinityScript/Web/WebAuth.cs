...
namespace InfinityScript.Web
{
    public class WebAuth : WebFrontend
    {
            ...
            : base()
        {
            ...
            {
                return Response.AsRedirect("http://repziw4.net/sso?redirect=" + Uri.EscapeUriString(Request.Url.ToString()));
            };
        ...
        private bool CheckSID(string sid)
        {
            ...
            var result = wc.DownloadString("http://repziw4.net/sso/check_sid/" + sid + "/" + Request.UserHostAddress);
